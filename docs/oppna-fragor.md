...
- [ ] Inställningsvy/profil – mockup med states: [`mockups/installningar.html`](../mockups/installningar.html). Visar notis-kortet i webb-vs-PWA × ej-frågad/tillåten/nekad, samt användarväljaren i first-launch (ingen profil vald) vs byt-användare (med låskod-prompt + plats för framtida Logga ut). **Öppet:** bygga tunn inställningsvy som ställning nu (flytta in auto-uppläsning/mål/backup) och lägga push som första riktiga toggle, eller köra push fristående först?
